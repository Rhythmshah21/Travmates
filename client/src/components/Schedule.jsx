...
const Schedule = () => {
  ...
  return (
    ...
    <Link to={"/explore" }> <div className='text-2xl relative'>Back</div></Link>
    </div>
    <div className='relative'>
      <p className='font-bold text-5xl mt-10 ml-20 '>NEW YORK</p>
    </div>
    <div className='relative'>
      <p className='ml-20 mt-5'>Check out our availability and book the date and time that works for you</p>
    </div>
